...
Увлекался созданием музыкальных композиций (FL Studio). В детстве итересовался Adobe After Effects, Adobe Photoshop + навыки пользования программами, связанными с документациями и нейросетями.
